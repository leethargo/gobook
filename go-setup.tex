...
\setmainfont[SmallCapsFont={Droid Sans Mono},Scale=MatchLowercase]{Droid Serif}
...
\renewcommand{\aftertoctitle}{\pagestyle{empty}}
\renewcommand{\aftertoctitle}{\thispagestyle{empty}\afterchaptertitle\pagestyle{empty}}
...
\renewcommand{\afterloftitle}{\thispagestyle{empty}}
...
\renewcommand{\afterlottitle}{\thispagestyle{empty}}
...
\renewcommand{\afterextitle}{\thispagestyle{empty}}
...
\renewcommand{\aftercodetitle}{\thispagestyle{empty}}
